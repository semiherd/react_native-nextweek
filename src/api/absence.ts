...
export const mock_updateAbsenceChanged:Api_UpdateAbsenceChanged= ApiResponse.update

export const mock_updateAbsence:Api_UpdateAbsence= ApiResponse.update

export const mock_readAbsence:Api_ReadAbsence={
	"absences": [
		{
			"_id": "absence1",
			"user": "user2",
...
export  const mock_createAbsence:Api_CreateAbsence={
	"absence": "64231f7e5c23cc34ac68fe5c"
}

export  const mock_deleteAbsence:Api_DeleteAbsence={
	"deletedAbsence": {
